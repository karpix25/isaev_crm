...
async def enrich_system_prompt(
    ...
    status_descriptions = {
        "NEW": "(Новый лид, пока мало данных)",
        "QUIZ_COMPLETED": "(Квиз пройден, ждем следующий шаг)",
        "MESSENGER_PENDING": "(Клиенту предложен мессенджер, но сообщения еще нет)",
        "DESIGN_PENDING": "(Ждем дизайн-проект от клиента)",
        "DESIGN_REVIEW": "(Дизайн-проект получен, нужен разбор/расчет)",
        "CONSULTING": "(Идет консультация)",
        "QUALIFIED": "(Лид квалифицирован, данные достаточны для следующего шага)",
        "MEASUREMENT_PENDING": "(Нужно записать клиента на замер)",
        "MEASUREMENT_BOOKED": "(Замер назначен, нужно подтвердить детали)",
        "MEASUREMENT": "(Замер в работе или согласован старым процессом)",
        "MEASUREMENT_DONE": "(Замер проведен, нужна смета)",
        "ESTIMATE_PREPARING": "(Смета готовится)",
        "ESTIMATE_REVIEW": "(Смета на проверке у сметчика)",
        "ESTIMATE_SENT": "(Смета отправлена, ждем реакцию)",
        "ESTIMATE": "(Смета в работе по старому процессу)",
        "FOLLOW_UP": "(Дожим/прогрев, клиент думает или молчит)",
        "CONTRACT_NEGOTIATION": "(Договор на согласовании)",
        "CONTRACT": "(Договор подписан)",
        "PAYMENT_PENDING": "(Договор подписан, ждем оплату)",
        "KEYS_PENDING": "(Оплата получена или старт согласован, ждем передачу ключей/доступа на объект)",
        "READY_TO_START": "(Ключи/доступ получены, объект готов к старту работ)",
        "WON": "(Объект в работе)",
        "LOST": "(Отказ)",
        "SPAM": "(Реклама/спам)"
    }

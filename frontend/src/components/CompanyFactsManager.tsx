        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    Простые настройки для ИИ: цены, сметы, портфолио, замер и услуги. Технические ключи создаются автоматически.
                </p>
            </div>
            ...
            <div className="rounded-2xl border bg-blue-50 p-4 text-sm text-blue-900">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <p className="mt-1">
                            Заполняйте только те поля, где нужна точная правда для ответов. Например: цена работ от 15000 ₽/м²,
                            смета готовится 24 часа, портфолио лежит по конкретной ссылке. Пустые поля ИИ не использует.
                        </p>
                    </div>
                </div>
            </div>

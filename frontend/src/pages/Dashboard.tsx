...
function ActionItem({ name, message, status, time, avatar }: ActionItemProps) {
    const statusColors: Record<string, string> = {
        ...
        [LeadStatus.PAYMENT_PENDING]: 'bg-emerald-500',
        [LeadStatus.KEYS_PENDING]: 'bg-lime-600',
        [LeadStatus.READY_TO_START]: 'bg-green-500',
        [LeadStatus.WON]: 'bg-green-700',
    ...
    const statusLabels: Record<string, string> = {
        ...
        [LeadStatus.KEYS_PENDING]: 'Ждем ключи',
        [LeadStatus.READY_TO_START]: 'Готов к старту',
